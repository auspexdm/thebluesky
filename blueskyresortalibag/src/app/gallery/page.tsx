    ...
    <>
      ...
      <Container as="section" className="py-12 sm:py-16">
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-charcoal-600 sm:text-lg">
          A closer look at the property. Room photography is still being
          finalized — those slots are marked below. Pool, café, and setting
          images are illustrative stock photos standing in until real
          property photography is ready.
        </p>
      </Container>
