...
export const metadata: Metadata = {
  ...
  description:
    "Browse real photos of The Blue Sky Resort Alibag — rooms, pool and outdoors, food and café, gatherings, and the Varsoli Beach setting.",
    ...
    <>
      ...
      <Container as="section" className="py-12 sm:py-16">
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-charcoal-600 sm:text-lg">
          A closer look at the property — photography is being finalized;
          placeholders below mark exactly what each image will show.
        </p>
      </Container>
