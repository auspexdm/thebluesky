  ...
  return (
    <>
      ...
      <Container as="section" className="grid gap-10 py-12 sm:py-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        <PlaceholderImage label="Extended family group relaxing together on the lawn" aspect="4/3" tone="ocean" />
      </Container>
          ...
          <Container>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {gatheringImages.map((img) => (
                <PlaceholderImage key={img.id} label={img.placeholderLabel} aspect="4/3" tone="sage" />
              ))}
            </div>
          </Container>
        </section>
