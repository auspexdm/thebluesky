 ...
 * GALLERY
 * ------------------------------------------------------------------
 * Room photos (category "stays") are still real-photo placeholders —
 * the resort team supplies these directly, so no stock substitute is
 * used for the rooms themselves.
 *
