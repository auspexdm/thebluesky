...
export interface GalleryImage {
  ...
  src?: string; // set once a real or approved stock photo exists at /public/images
  credit?: string; // required when isStockOrIllustrative is true — renders as an on-image caption
}
